  ...
  return (
    <html lang="en" className={roboto.variable}>
      <head>
        ...
        <meta
          property="og:image"
          content="https://d3nt41cjjw3im8.cloudfront.net/assets/mahaNav.png"
        />
        ...
        <meta
          ...
          content="u9H8h_QMkGNeHrV5UdXi4Yu9UHJvnGus0OjLf5eD9eI"
        />

        {/* Bing Webmaster */}
        <meta
          name="msvalidate.01"
          content="B0C3901713DC861A2D246AE7AA76AB50"
        />

        {/* Google Analytics */}
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-83K7WLQL7T"
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-MNN69C77');
            `,
          }}
        />
      ...
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-MNN69C77"
            height="0"
            width="0"
