    ...
    <>
      <div className={`footer py-60 ${locale === "ar" ? "r_dir" : "l_dir"}`}>
        <div className="container">
          ...
          <div
            className={locale == "ar" ? "moreInfo arB" : "moreInfo"}
            style={{ display: "none" }} // Hides from the UI but keeps it in HTML for SEO
            aria-hidden="false" // Ensures it's still accessible for SEO and screen readers
          >
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header as="p">More Information</Accordion.Header>
